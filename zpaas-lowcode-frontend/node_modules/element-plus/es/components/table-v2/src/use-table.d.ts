...
declare function useTable(props: TableV2Props): {
  ...
  containerRef: vue.Ref<any>;
  mainTableRef: vue.Ref<TableGridInstance | undefined>;
  leftTableRef: vue.Ref<TableGridInstance | undefined>;
  rightTableRef: vue.Ref<TableGridInstance | undefined>;
  isDynamic: vue.ComputedRef<boolean>;
  isResetting: vue.ShallowRef<boolean>;
  isScrolling: vue.ShallowRef<boolean>;
  ...
  expandedRowKeys: vue.Ref<KeyType[]>;
  depthMap: vue.Ref<Record<KeyType, number>>;

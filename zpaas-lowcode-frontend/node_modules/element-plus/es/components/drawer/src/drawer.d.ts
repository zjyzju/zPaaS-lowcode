...
declare const drawerProps: {
  ...
  readonly transition: EpPropFinalized<(new (...args: any[]) => string | vue.TransitionProps) | (() => DialogTransition) | ((new (...args: any[]) => string | vue.TransitionProps) | (() => DialogTransition))[], unknown, unknown, undefined, boolean>;

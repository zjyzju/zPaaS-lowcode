...
declare const __VLS_base: vue.DefineComponent<__VLS_WithDefaults<__VLS_TypePropsToOption<StepsProps>, {
  space: string;
  direction: string;
  active: number;
...
}, string, vue.PublicProps, Readonly<vue.ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToOption<StepsProps>, {
  space: string;
  direction: string;
  active: number;
  processStatus: string;

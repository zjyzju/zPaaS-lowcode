...
declare const focusReason: vue.Ref<"pointer" | "keyboard" | undefined>;
declare const lastUserFocusTimestamp: vue.Ref<number>;
declare const lastAutomatedFocusTimestamp: vue.Ref<number>;
type FocusLayer = {
  paused: boolean;
  pause: () => void;
  resume: () => void;

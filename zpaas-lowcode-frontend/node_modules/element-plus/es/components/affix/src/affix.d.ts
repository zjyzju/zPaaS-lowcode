...
declare const affixProps: {
  readonly zIndex: EpPropFinalized<(new (...args: any[]) => string | number) | (() => csstype.Property.ZIndex | undefined) | ((new (...args: any[]) => string | number) | (() => csstype.Property.ZIndex | undefined))[], unknown, unknown, 100, boolean>;

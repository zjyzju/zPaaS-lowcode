	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return __props.options.length ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
				...
				}, null, 42, _hoisted_2), (0, vue.createElementVNode)("div", { class: (0, vue.normalizeClass)((0, vue.unref)(ns).e("item-label")) }, [(0, vue.renderSlot)(_ctx.$slots, "default", { item: intoAny(item) }, () => [(0, vue.createTextVNode)((0, vue.toDisplayString)(getLabel(item)), 1)])], 2)], 2);

...
declare const useTooltipProps: {
  ...
  trigger: EpPropFinalized<(new (...args: any[]) => "focus" | "hover" | "click" | "contextmenu" | TooltipTriggerType[]) | (() => Arrayable<TooltipTriggerType>) | ((new (...args: any[]) => "focus" | "hover" | "click" | "contextmenu" | TooltipTriggerType[]) | (() => Arrayable<TooltipTriggerType>))[], unknown, unknown, "hover", boolean>;

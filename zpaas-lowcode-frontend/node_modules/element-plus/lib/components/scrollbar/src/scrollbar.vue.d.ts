...
declare const __VLS_base: vue.DefineComponent<__VLS_WithDefaults<__VLS_TypePropsToOption<ScrollbarProps>, {
  distance: number;
  height: string;
  maxHeight: string;
  wrapStyle: string;
  ...
  /** @description scrollbar wrap ref */wrapRef: vue.Ref<HTMLDivElement | undefined>; /** @description update scrollbar state manually */
...
}, string, vue.PublicProps, Readonly<vue.ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToOption<ScrollbarProps>, {
  distance: number;
  height: string;
  maxHeight: string;
  wrapStyle: string;

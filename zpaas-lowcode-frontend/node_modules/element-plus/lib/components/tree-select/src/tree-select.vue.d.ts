...
declare const __VLS_export: vue.DefineComponent<{
  ...
  data: EpPropFinalized<(new (...args: any[]) => TreeData) | (() => TreeData) | ((new (...args: any[]) => TreeData) | (() => TreeData))[], unknown, unknown, () => never[], boolean>;
  emptyText: {
  ...
  props: EpPropFinalized<(new (...args: any[]) => TreeOptionProps) | (() => TreeOptionProps) | ((new (...args: any[]) => TreeOptionProps) | (() => TreeOptionProps))[], unknown, unknown, () => {
    children: string;
    label: string;
    disabled: string;
  }, boolean>;

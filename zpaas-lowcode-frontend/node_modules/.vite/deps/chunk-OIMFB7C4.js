import {
  ...
  resizeBounds,
  substractTRBL
} from "./chunk-UTR2AYLT.js";
import {
  getParent,
  isDirectionHorizontal
} from "./chunk-M3K2EWQA.js";
import {
  isDifferentType
} from "./chunk-MNI24GEP.js";
import {
  BaseViewer,
  CommandInterceptor,
  DEFAULT_LABEL_SIZE,
...
import {
  ...
  isHorizontal,
  isInterrupting
} from "./chunk-TYIJONHA.js";
import {
  getBusinessObject,
  getDi,
  is,
  isAny
} from "./chunk-AVJ2HEUM.js";
import {
  assign,
  bind,
  debounce,
...
function C(n3) {
  if (n3.__P && n3.__d) {
    var u3 = n3.__v, t4 = u3.__e, i3 = [], r4 = [], o3 = w({}, u3);
    o3.__v = u3.__v + 1, l.vnode && l.vnode(o3), z(n3.__P, o3, u3, n3.__n, n3.__P.namespaceURI, 32 & u3.__u ? [t4] : null, i3, null == t4 ? S(u3) : t4, !!(32 & u3.__u), r4), o3.__v = u3.__v, o3.__.__k[o3.__i] = o3, V(i3, o3, r4), u3.__e = u3.__ = null, o3.__e != t4 && M(o3);
  }
}
function M(n3) {
...
function I() {
  try {
    for (var n3, l3 = 1; i.length; ) i.length > l3 && i.sort(e2), n3 = i.shift(), l3 = i.length, C(n3);
  } finally {
    i.length = I.__r = 0;
  }
}
function P(n3, l3, u3, t4, i3, r4, o3, e4, f3, c3, s3) {
  var a3, h3, y3, d3, w3, g3, _3, m4 = t4 && t4.__k || v, b2 = l3.length;
  for (f3 = A(u3, l3, m4, f3, b2), a3 = 0; a3 < b2; a3++) null != (y3 = u3.__k[a3]) && (h3 = -1 != y3.__i && m4[y3.__i] || p, y3.__i = a3, g3 = z(n3, y3, h3, i3, r4, o3, e4, f3, c3, s3), d3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && D(h3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), (_3 = !!(4 & y3.__u)) || h3.__k === y3.__k ? f3 = H(y3, f3, n3, _3) : "function" == typeof y3.type && void 0 !== g3 ? f3 = g3 : d3 && (f3 = d3.nextSibling), y3.__u &= -7);
  return u3.__e = w3, f3;
}
function A(n3, l3, u3, t4, i3) {
  var r4, o3, e4, f3, c3, s3 = u3.length, a3 = s3, h3 = 0;
  for (n3.__k = new Array(i3), r4 = 0; r4 < i3; r4++) null != (o3 = l3[r4]) && "boolean" != typeof o3 && "function" != typeof o3 ? ("string" == typeof o3 || "number" == typeof o3 || "bigint" == typeof o3 || o3.constructor == String ? o3 = n3.__k[r4] = m(null, o3, null, null, null) : d(o3) ? o3 = n3.__k[r4] = m(k, { children: o3 }, null, null, null) : void 0 === o3.constructor && o3.__b > 0 ? o3 = n3.__k[r4] = m(o3.type, o3.props, o3.key, o3.ref ? o3.ref : null, o3.__v) : n3.__k[r4] = o3, f3 = r4 + h3, o3.__ = n3, o3.__b = n3.__b + 1, e4 = null, -1 != (c3 = o3.__i = T(o3, u3, f3, a3)) && (a3--, (e4 = u3[c3]) && (e4.__u |= 2)), null == e4 || null == e4.__v ? (-1 == c3 && (i3 > s3 ? h3-- : i3 < s3 && h3++), "function" != typeof o3.type && (o3.__u |= 4)) : c3 != f3 && (c3 == f3 - 1 ? h3-- : c3 == f3 + 1 ? h3++ : (c3 > f3 ? h3-- : h3++, o3.__u |= 4))) : n3.__k[r4] = null;
  if (a3) for (r4 = 0; r4 < s3; r4++) null != (e4 = u3[r4]) && 0 == (2 & e4.__u) && (e4.__e == t4 && (t4 = S(e4)), E(e4, e4));
  return t4;
}
function H(n3, l3, u3, t4) {
  var i3, r4;
  if ("function" == typeof n3.type) {
    for (i3 = n3.__k, r4 = 0; i3 && r4 < i3.length; r4++) i3[r4] && (i3[r4].__ = n3, l3 = H(i3[r4], l3, u3, t4));
    return l3;
  }
...
function T(n3, l3, u3, t4) {
  var i3, r4, o3, e4 = n3.key, f3 = n3.type, c3 = l3[u3], s3 = null != c3 && 0 == (2 & c3.__u);
  if (null === c3 && null == e4 || s3 && e4 == c3.key && f3 == c3.type) return u3;
  if (t4 > (s3 ? 1 : 0)) {
...
function F(n3, l3, u3, t4, i3) {
  ...
  else if ("o" == l3[0] && "n" == l3[1]) r4 = l3 != (l3 = l3.replace(f, "$1")), o3 = l3.toLowerCase(), l3 = o3 in n3 || "onFocusOut" == l3 || "onFocusIn" == l3 ? o3.slice(2) : l3.slice(2), n3.l || (n3.l = {}), n3.l[l3 + r4] = u3, u3 ? t4 ? u3.u = t4.u : (u3.u = c, n3.addEventListener(l3, r4 ? a : s, r4)) : n3.removeEventListener(l3, r4 ? a : s, r4);
  else {
...
function z(n3, u3, t4, i3, r4, o3, e4, f3, c3, s3) {
  ...
  else null == o3 && u3.__v == t4.__v ? (u3.__k = t4.__k, u3.__e = t4.__e) : f3 = u3.__e = B(t4.__e, u3, t4, i3, r4, o3, e4, c3, s3);
...
function B(u3, t4, i3, r4, o3, e4, f3, c3, s3) {
  var a3, h3, v3, y3, w3, _3, m4, b2 = i3.props || p, k3 = t4.props, x3 = t4.type;
  if ("svg" == x3 ? o3 = "http://www.w3.org/2000/svg" : "math" == x3 ? o3 = "http://www.w3.org/1998/Math/MathML" : o3 || (o3 = "http://www.w3.org/1999/xhtml"), null != e4) {
    for (a3 = 0; a3 < e4.length; a3++) if ((w3 = e4[a3]) && "setAttribute" in w3 == !!x3 && (x3 ? w3.localName == x3 : 3 == w3.nodeType)) {
      u3 = w3, e4[a3] = null;
      break;
    }
  }
  ...
  if (null == x3) b2 === k3 || c3 && u3.data == k3 || (u3.data = k3);
    ...
    if (e4 = e4 && n.call(u3.childNodes), !c3 && null != e4) for (b2 = {}, a3 = 0; a3 < u3.attributes.length; a3++) b2[(w3 = u3.attributes[a3]).name] = w3.value;
    ...
    for (a3 in k3) w3 = k3[a3], "children" == a3 ? y3 = w3 : "dangerouslySetInnerHTML" == a3 ? h3 = w3 : "value" == a3 ? _3 = w3 : "checked" == a3 ? m4 = w3 : c3 && "function" != typeof w3 || b2[a3] === w3 || F(u3, a3, w3, b2[a3], o3);
    if (h3) c3 || v3 && (h3.__html == v3.__html || h3.__html == u3.innerHTML) || (u3.innerHTML = h3.__html), t4.__k = [];
    else if (v3 && (u3.innerHTML = ""), P("template" == t4.type ? u3.content : u3, d(y3) ? y3 : [y3], t4, i3, r4, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o3, e4, f3, e4 ? e4[0] : i3.__k && S(i3, 0), c3, s3), null != e4) for (a3 = e4.length; a3--; ) g(e4[a3]);
    c3 || (a3 = "value", "progress" == x3 && null == _3 ? u3.removeAttribute("value") : null != _3 && (_3 !== u3[a3] || "progress" == x3 && !_3 || "option" == x3 && _3 != b2[a3]) && F(u3, a3, _3, b2[a3], o3), a3 = "checked", null != m4 && m4 != u3[a3] && F(u3, a3, m4, b2[a3], o3));
  }
  return u3;
}
function D(n3, u3, t4) {
...
function E(n3, u3, t4) {
  ...
  if (i3 = n3.__k) for (r4 = 0; r4 < i3.length; r4++) i3[r4] && E(i3[r4], u3, t4 || "function" != typeof n3.type);
...
function J(u3, t4, i3) {
  var r4, o3, e4, f3;
  t4 == document && (t4 = document.documentElement), l.__ && l.__(u3, t4), o3 = (r4 = "function" == typeof i3) ? null : i3 && i3.__k || t4.__k, e4 = [], f3 = [], z(t4, u3 = (!r4 && i3 || t4).__k = _(k, null, [u3]), o3 || p, p, t4.namespaceURI, !r4 && i3 ? [i3] : o3 ? null : t4.firstChild ? n.call(t4.childNodes) : null, e4, !r4 && i3 ? i3 : o3 ? o3.__e : t4.firstChild, r4, f3), V(e4, u3, f3);
}
...
function PopupMenuHeader(props) {
  ...
  const handleClick = (event2, entry) => {
    if (!isActionable(entry)) {
      return;
    }
    return onSelect(event2, entry);
  };
  return m2`
          ...
          ${group.entries.map((entry) => m2`
            <li key=${entry.id}>
              <${isActionable(entry) ? "button" : "span"}
                ...
                onClick=${(event2) => handleClick(event2, entry)}
...
function PopupMenuItem(props) {
  ...
  const handleClick = (event2, action) => {
    if (entry.disabled) {
      return;
    }
...
function PopupMenuComponent(props) {
  ...
  const [entries, setEntries] = d2(filterEntries(originalEntries, searchValue));
  const [selectedEntry, setSelectedEntry] = d2(entries[0]);
  const groupedEntries = T2(() => groupEntries2(entries), [entries]);
...
function matchItem(item, words, keys2) {
  const {
    ...
    } = isArray(itemValue) ? itemValue.reduce(
      (result2, itemString) => {
        const { tokens: tokens3, matchedWords: matchedWords3 } = matchString(itemString, words);
        return {
          tokens: [...result2.tokens, tokens3],
          matchedWords: {
            ...result2.matchedWords,
            ...matchedWords3
          }
        };
      },
...
function compareStrings(a3, b2) {
  return stringJoin(a3).localeCompare(stringJoin(b2));
}
...
function CreateDataObjectBehavior(eventBus, bpmnFactory) {
  ...
  this.preExecute("shape.create", function(event2) {
    ...
    if (is(shape, "bpmn:DataObjectReference") && shape.type !== "label") {
      ...
      dataObject.isCollection = ((_a = shape.businessObject.dataObjectRef) == null ? void 0 : _a.isCollection) || false;
...
BpmnRules.prototype.init = function() {
  ...
  this.addRule("elements.move", function(context) {
    var target = context.target, shapes = context.shapes, position = context.position, hints = context.hints;
    if (hints == null ? void 0 : hints.keyboardMove) {
...
function CopyPaste(canvas, create2, clipboard, elementFactory, eventBus, modeling, mouse, rules) {
  ...
  eventBus.on("copyPaste.elementsCopied", HIGH_PRIORITY11, function(context) {
    var _a;
    if (((_a = context.hints) == null ? void 0 : _a.clip) !== false) {
...
ModdleCopy.prototype.copyElement = function(sourceElement, targetElement, propertyNames, clone2 = false) {
  ...
  forEach(propertyNames, (propertyName) => {
    ...
    const copiedProperty = this.copyProperty(sourceProperty, targetElement, propertyName, clone2);
...
ModdleCopy.prototype.copyProperty = function(property, parent, propertyName, clone2 = false) {
  ...
  if (isArray(property)) {
    return reduce(property, (childProperties, childProperty) => {
      const copiedProperty2 = this.copyProperty(childProperty, parent, propertyName, clone2);
      if (copiedProperty2) {
        return childProperties.concat(copiedProperty2);
      }
  ...
  if (isObject(property) && property.$type) {
    ...
    copiedProperty.$parent = parent;
    copiedProperty = this.copyElement(property, copiedProperty, null, clone2);
    return copiedProperty;
  }
  return property;
};
...
function AttachSupport(injector, eventBus, canvas, rules, modeling) {
  CommandInterceptor.call(this, eventBus);
  var movePreview = injector.get("movePreview", false);
  eventBus.on("shape.move.start", HIGH_PRIORITY14, function(e4) {
    var context = e4.context, shapes = context.shapes, validatedShapes = context.validatedShapes;
  ...
  this.preExecuted("elements.move", HIGH_PRIORITY14, function(e4) {
...
// node_modules/bpmn-js/lib/features/label-link/LabelLink.js
var ALLOWED_ELEMENTS = ["bpmn:Event", "bpmn:SequenceFlow", "bpmn:Gateway"];
var LINE_STYLE = {
...
var PATH_OFFSET = 2;
function LabelLink(eventBus, canvas, graphicsFactory, outline, selection) {
  ...
  eventBus.on("selection.changed", function({ newSelection }) {
    ...
    if (allowedElements.length === 1) {
      ...
      } else if ((_a = element.labels) == null ? void 0 : _a.length) {
        createLink(element.labels[0], element, newSelection);
      }
    }
    if (allowedElements.length === 2) {
      const label = allowedElements.find(isLabel);
      const target = allowedElements.find((el) => {
        var _a2;
        return (_a2 = el.labels) == null ? void 0 : _a2.includes(label);
      });
      if (label && target) {
  ...
  function cleanUp() {
    all(`.${LINE_STYLE.class}`, layer).forEach(remove2);
  }
...
function parseSvgNumAttr(node, attr3) {
  return parseFloat(attr2(node, attr3) || 0);
}

// node_modules/bpmn-js/lib/features/label-link/index.js
var label_link_default = {
  __depends__: [
    selection_default,
    outline_default
  ],
...
function HandTool(eventBus, canvas, dragging, injector, toolManager, mouse) {
  ...
  keyboard && keyboard.addListener(HIGH_PRIORITY20, function(e4) {
...
//# sourceMappingURL=chunk-OIMFB7C4.js.map

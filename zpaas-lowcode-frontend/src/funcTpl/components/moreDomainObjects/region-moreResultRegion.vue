		        ...
		        <template #default="scope">
		            <span v-if="funcRegion.regionOperations != null" v-for="operation in funcRegion.regionOperations">
                        ...
                        <template v-if="operation.operationType == 'V'">
                            <popupViewComponent :operation="operation" :regionData="scope.row" :funcRegion="funcRegion" :funcDefine="funcDefine"/>&nbsp;
                        </template>
                    </span>
		        </template>
		    </el-table-column>
...
import {processLabelValue, generateReqObject, validateReqData} from '../../js/common.js'
...
export default {
    ...
    methods: {
    	executeOperation(operation, data) {
            ...
            }else if(operation.operationType == "P") {

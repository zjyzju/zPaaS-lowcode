...
import {interactionProcess, formatAttrDisplayInfo, generateReqObject, validateReqData} from '../../js/common.js'
                ...
                if(operation.exposedServiceMapping != null && operation.exposedServiceMapping.trim().length > 0) {
                    ...
                    axiosClient.post(url, req).then((response) => {
                        ...
                        if(result != null && result.status == '200') {
                            this.operationExecuted(operation, result, data, this.funcRegion);
                        }else {

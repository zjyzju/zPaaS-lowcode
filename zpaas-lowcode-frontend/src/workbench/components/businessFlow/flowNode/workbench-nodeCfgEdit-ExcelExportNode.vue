<!-- Excel文件导出节点-节点配置信息-编辑页 -->

<template v-if="showNodeCfgEdit == 'ExcelExportNode' && nodeCfgJson != null && nodeCfgJson.isListResult != null">
	<el-row :gutter="4">
        <el-col :span="16">
        ...
        <el-col :span="5">
            <el-checkbox v-model="nodeCfgJson.isReOrder" label="重排序" />
        </el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="12">
    ...
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="模板来源">
                <el-select v-model="nodeCfgJson.excelTemplateSource" clearable class="m-2" placeholder="Select" size="small">
                    <el-option v-for="item in excelTemplateSourceOptions" :key="item.value" :label="item.label" :value="item.value" />
                </el-select>
            </el-form-item>
        </el-col>
        <el-col :span="8">
		    <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(excelTemplateSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.excelTemplateSource=contextType;this.nodeCfgJson.excelTemplateKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
		</el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="模板Key">
                <el-input v-model="nodeCfgJson.excelTemplateKey" size="small" />
            </el-form-item>
        </el-col>
    ...
    <el-row :gutter="4">
        <el-col :span="12">
            <el-form-item label="sheet页号">
                <el-input v-model="nodeCfgJson.sheetIndex" size="small" />
            </el-form-item>
        </el-col>
        <el-col :span="12">
    ...
    <el-row :gutter="4">
	    ...
	    <el-col :span="22">
	        ...
	        <el-row :gutter="4">
	            <el-col :span="12">
	                <el-form-item label="列序号" label-width='90px'>
	        ...
	        <el-row :gutter="4">
                <el-col :span="12">
                    <el-form-item label="属性名" label-width='90px'>
                        <el-input v-model="mappingName" size="small" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="表头名" label-width='90px'>
            ...
            <el-row :gutter="4">
                <el-col :span="12">
                    <el-form-item label="" label-width='90px'>
                        <el-checkbox v-model="needMerge" label="是否合并" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="" label-width='90px'>
                        <el-checkbox v-model="isSum" label="是否累加" />
                    </el-form-item>
                </el-col>
            </el-row>
             <el-row :gutter="4">
                <el-col :span="12">
                    <el-form-item label="累加维度列" label-width='90px'>
                        <el-input v-model="sumByColumnIndex" size="small" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="累加列" label-width='90px'>
                        <el-input v-model="sumColumnIndex" size="small" />
                    </el-form-item>
                </el-col>
            </el-row>
	       ...
	       <el-row :gutter="4">
	            ...
	            <el-scrollbar  height="200px">
	                <el-table ref="columnMappingsTable" :data="nodeCfgJson.columnMappings" stripe style="width: 100%">
	                    ...
	                    <el-table-column prop="needMerge" label="是否合并" width="80" >
	                       <template  #default="scope">
                               <div style="display: flex; align-items: center">
                                   <span v-if="scope.row.needMerge == true">是</span>
                                   <span v-if="scope.row.needMerge != true">否</span>
                               </div>
                           </template>
	                    </el-table-column>
	                    <el-table-column prop="isSum" label="是否累加" width="80" >
	                       <template  #default="scope">
                               <div style="display: flex; align-items: center">
                                   <span v-if="scope.row.isSum == true">是</span>
                                   <span v-if="scope.row.isSum != true">否</span>
                               </div>
                           </template>
	                    </el-table-column>
	                    <el-table-column prop="sumByColumnIndex" label="累加维度列" width="100" />
	                    <el-table-column prop="sumColumnIndex" label="累加列" width="100" />
	                </el-table>
	            </el-scrollbar>
	            </el-col>
	        </el-row>
...
export default {
    ...
    data() {            
    	...
    	const excelTemplateSourceOptions = ref(null);
    ...
    mounted() {
        axiosClient.post("/lcdp-proxy/lowcode/platform/be/api/dict/getDictLabelValues", ['OBJECT_SOURCE_TYPE','OBJECT_SOURCE_TYPE_TWO','OBJECT_TYPE']).then((response) => {
            var data = response.data; 
            if(data != null && data.status == "200" && data.data != null) {
                this.objectAttrSourceOptions = data.data['OBJECT_SOURCE_TYPE'];
                this.excelTemplateSourceOptions = data.data['OBJECT_SOURCE_TYPE_TWO'];

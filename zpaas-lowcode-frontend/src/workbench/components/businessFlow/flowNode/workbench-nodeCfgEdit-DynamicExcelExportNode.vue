<!-- 动态Excel文件导出节点-节点配置信息-编辑页 -->

<template v-if="showNodeCfgEdit == 'DynamicExcelExportNode' && nodeCfgJson != null && nodeCfgJson.isListResult != null">
	<el-row :gutter="4">
        <el-col :span="16">
    ...
    <el-row :gutter="4">
        ...
        <el-col :span="8">
            &nbsp;&nbsp;<el-checkbox v-model="nodeCfgJson.exportHeader" label="导出表头" />
        </el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="Excel模板来源">
    ...
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="Excel模板 Key">
    ...
    <el-row :gutter="4">
        ...
        <el-col :span="8">
		    <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(objectAttrSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.keyValueSource=contextType;this.nodeCfgJson.keyValueKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
		</el-col>
    </el-row>
    <el-row :gutter="4">
...
export default {
    ...
    data() {            
       ...
       const nodeResultTypeOptions = ref(null);
        ...
        const queryDynamicMappingCondition = ref({"mappingType":"F"});

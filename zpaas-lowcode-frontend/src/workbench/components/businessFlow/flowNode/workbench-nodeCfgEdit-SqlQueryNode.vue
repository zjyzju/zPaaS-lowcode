...
<template v-if="showNodeCfgEdit == 'SqlQueryNode' && nodeCfgJson != null && nodeCfgJson.isListResult != null">
	<el-row :gutter="4">
        <el-col :span="16">
    ...
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="是否分页">
                <el-checkbox v-model="nodeCfgJson.pageFlag" label="分页" />
            </el-form-item>
        </el-col>
...
export default {
    props: ['showNodeCfgEdit','nodeCfgJson','systemId', 'dbSchemaId'],
    ...
    methods: {
    	selectSql() {
    		...
    		var url = "/lcdp-proxy/lowcode/platform/be/api/sqlManagement/list/" + this.systemId + "/D/" + this.dbSchemaId;

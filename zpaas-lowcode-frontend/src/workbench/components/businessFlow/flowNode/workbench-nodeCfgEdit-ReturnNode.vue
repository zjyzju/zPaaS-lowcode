<!-- ReturnNode-节点配置信息-编辑页 -->

<template v-if="showNodeCfgEdit == 'ReturnNode' && nodeCfgJson != null && nodeCfgJson.isListResult != null">
	<el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="返回对象来源">
                <el-select v-model="nodeCfgJson.returnObjectInstanceSource" class="m-2" placeholder="Select" size="small">
        ...
        <el-col :span="3">
		    <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(objectSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.returnObjectInstanceSource=contextType;this.nodeCfgJson.returnObjectInstanceKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
		</el-col>
        <el-col :span="5">
    ...
    <el-row :gutter="4">
        <el-col :span="12">
            <el-form-item label="返回对象Key">
                <el-input v-model="nodeCfgJson.returnObjectInstanceKey" size="small" />
            </el-form-item>
        </el-col>
        <el-col :span="12">
            <el-form-item label="返回对象属性">
                <el-input v-model="nodeCfgJson.returnObjectInstanceAttr" size="small" />
            </el-form-item>
        </el-col>
    </el-row>

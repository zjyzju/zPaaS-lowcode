<!-- Excel文件导入节点-节点配置信息-编辑页 -->

<template v-if="showNodeCfgEdit == 'ExcelImportNode' && nodeCfgJson != null && nodeCfgJson.isListResult != null">
	<el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="文件来源">
                <el-select v-model="nodeCfgJson.excelFileSource" clearable class="m-2" placeholder="Select" size="small">
                    <el-option v-for="item in excelFileSourceOptions" :key="item.value" :label="item.label" :value="item.value" />
                </el-select>
            </el-form-item>
        </el-col>
	...
	<el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="文件名来源">
                <el-select v-model="nodeCfgJson.excelFileNameSource" clearable class="m-2" placeholder="Select" size="small">
        ...
        <el-col :span="8">
		    <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(objectAttrSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.excelFileNameSource=contextType;this.nodeCfgJson.excelFileNameKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
		</el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="12">
            <el-form-item label="文件名Key">
                <el-input v-model="nodeCfgJson.excelFileNameKey" size="small" />
            </el-form-item>
        </el-col>
        <el-col :span="12">
            <el-form-item label="文件名属性">
                <el-input v-model="nodeCfgJson.excelFileNameAttr" size="small" />
            </el-form-item>
        </el-col>
    </el-row>
    <el-row :gutter="4">
    ...
    <el-row :gutter="4">
	    ...
	    <el-col :span="22">
	        ...
	        <el-row :gutter="4">
	            <el-col :span="16">
	                <el-form-item label="excel列序号" label-width='100px'>
	       ...
	       <el-row :gutter="4">
	            ...
	            <el-scrollbar  height="200px">
	                <el-table ref="columnMappingsTable" :data="nodeCfgJson.columnMappings" stripe style="width: 100%">
	                    ...
	                    <el-table-column prop="columnIndex" label="excel列序号" width="120" />
...
export default {
    ...
    data() {            
    	const excelFileSourceOptions = ref(null);
    ...
    mounted() {
        axiosClient.post("/lcdp-proxy/lowcode/platform/be/api/dict/getDictLabelValues", ['OBJECT_SOURCE_TYPE_WITH_PRE','FILE_SOURCE_TYPE','OBJECT_TYPE','FILE_PROCESS_MODE']).then((response) => {
            ...
            if(data != null && data.status == "200" && data.data != null) {
                ...
                this.excelFileSourceOptions = data.data['FILE_SOURCE_TYPE'];

...
<template v-if="showNodeCfgEdit == 'DynamicGetterNode' && nodeCfgJson != null && nodeCfgJson.isListResult != null">
	<el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="源对象来源">
                <el-select v-model="nodeCfgJson.fromObjectSource" class="m-2" placeholder="Select" size="small">
        ...
        <el-col :span="8">
		    <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(objectSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.fromObjectSource=contextType;this.nodeCfgJson.fromObjectKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
		</el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="源对象Key">
                <el-input v-model="nodeCfgJson.fromObjectKey" size="small" />
            </el-form-item>
        </el-col>
        <el-col :span="8">
    ...
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="属性来源">
                <el-select v-model="nodeCfgJson.fromObjectAttrSource" clearable class="m-2" placeholder="Select" size="small">
        ...
        <el-col :span="8">
		    <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(objectAttrSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.fromObjectAttrSource=contextType;this.nodeCfgJson.fromObjectAttrKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
		</el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="12">
            <el-form-item label="属性Key">
                <el-input v-model="nodeCfgJson.fromObjectAttrKey" size="small" />
            </el-form-item>
        </el-col>
        <el-col :span="12">
            <el-form-item label="属性属性">
                <el-input v-model="nodeCfgJson.fromObjectAttrAttr" size="small" />
            </el-form-item>
        </el-col>
    </el-row>
...
export default {
    ...
    mounted() {
        axiosClient.post("/lcdp-proxy/lowcode/platform/be/api/dict/getDictLabelValues", ['OBJECT_SOURCE_TYPE_WITH_PRE','OBJECT_SOURCE_TYPE','OBJECT_TYPE']).then((response) => {

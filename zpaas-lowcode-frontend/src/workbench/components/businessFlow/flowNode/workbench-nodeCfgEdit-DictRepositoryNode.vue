...
<template v-if="showNodeCfgEdit == 'DictRepositoryNode' && nodeCfgJson != null && nodeCfgJson.isListResult != null">
	<el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="字典资源">
                <el-select v-model="nodeCfgJson.dictResourceId" class="m-2" placeholder="Select" size="small">
	                <el-option v-for="item in dictResources" :key="item.id" :label="item.name" :value="item.id" />
	            </el-select>
            </el-form-item>
        </el-col>
    ...
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="字典编码来源">
                <el-select v-model="nodeCfgJson.dictCodeSource" clearable class="m-2" placeholder="Select" size="small">
        ...
        <el-col :span="8">
		    <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(objectAttrSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.dictCodeSource=contextType;this.nodeCfgJson.dictCodeKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
		</el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="12">
            <el-form-item label="字典编码Key">
                <el-input v-model="nodeCfgJson.dictCodeKey" size="small" />
            </el-form-item>
        </el-col>
        <el-col :span="12">
            <el-form-item label="字典编码属性">
                <el-input v-model="nodeCfgJson.dictCodeAttr" size="small" />
            </el-form-item>
        </el-col>
    </el-row>
    ...
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="字典值来源">
                <el-select v-model="nodeCfgJson.dictValueSource" clearable class="m-2" placeholder="Select" size="small">
                    <el-option v-for="item in objectAttrSourceOptions" :key="item.value" :label="item.label" :value="item.value" />
                </el-select>
            </el-form-item>
        </el-col>
        <el-col :span="8">
		    <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(objectAttrSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.dictValueSource=contextType;this.nodeCfgJson.dictValueKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
		</el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="12">
            <el-form-item label="字典值Key">
                <el-input v-model="nodeCfgJson.dictValueKey" size="small" />
            </el-form-item>
        </el-col>
        <el-col :span="12">
            <el-form-item label="字典值属性">
                <el-input v-model="nodeCfgJson.dictValueAttr" size="small" />
            </el-form-item>
        </el-col>
    </el-row>
    ...
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="上级字典来源">
                <el-select v-model="nodeCfgJson.parentDictCodeSource" clearable class="m-2" placeholder="Select" size="small">
                    <el-option v-for="item in objectAttrSourceOptions" :key="item.value" :label="item.label" :value="item.value" />
                </el-select>
            </el-form-item>
        </el-col>
        <el-col :span="8">
		    <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(objectAttrSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.parentDictCodeSource=contextType;this.nodeCfgJson.parentDictCodeKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
		</el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="12">
            <el-form-item label="上级字典Key">
                <el-input v-model="nodeCfgJson.parentDictCodeKey" size="small" />
            </el-form-item>
        </el-col>
        <el-col :span="12">
            <el-form-item label="上级字典属性">
                <el-input v-model="nodeCfgJson.parentDictCodeAttr" size="small" />
            </el-form-item>
        </el-col>
    </el-row>
    ...
    <el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="上级值来源">
                <el-select v-model="nodeCfgJson.parentDictValueSource" clearable class="m-2" placeholder="Select" size="small">
                    <el-option v-for="item in objectAttrSourceOptions" :key="item.value" :label="item.label" :value="item.value" />
                </el-select>
            </el-form-item>
        </el-col>
        <el-col :span="8">
		    <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(objectAttrSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.parentDictValueSource=contextType;this.nodeCfgJson.parentDictValueKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
		</el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="12">
            <el-form-item label="上级值Key">
                <el-input v-model="nodeCfgJson.parentDictValueKey" size="small" />
            </el-form-item>
        </el-col>
        <el-col :span="12">
            <el-form-item label="上级值属性">
                <el-input v-model="nodeCfgJson.parentDictValueAttr" size="small" />
            </el-form-item>
        </el-col>
    </el-row>
...
export default {
    ...
    mounted() {
        axiosClient.post("/lcdp-proxy/lowcode/platform/be/api/dict/getDictLabelValues", ['OBJECT_SOURCE_TYPE_WITH_PRE','OBJECT_TYPE']).then((response) => {
        ...
        var url = "/lcdp-proxy/lowcode/platform/be/api/dictResource/list/" + this.systemId;
        axiosClient.get(url).then((response) => {
            var data = response.data; 
            if(data != null && data.status == "200" && data.data != null) {
                this.dictResources = data.data;
                if(this.dictResources != null && this.dictResources.length > 0 && (this.nodeCfgJson.dictResourceId == null || this.nodeCfgJson.dictResourceId == "") ) {
                    this.nodeCfgJson.dictResourceId = this.dictResources[0].id;
                }
            }
        });
    },     

...
<template v-if="showNodeCfgEdit == 'DynamicTransferNode' && nodeCfgJson != null && nodeCfgJson.isListResult != null">
	<el-row :gutter="4">
        <el-col :span="16">
...
export default {
    ...
    data() {            
        ...
        const queryDynamicMappingCondition = ref({"mappingType":"D"});
    ...
    mounted() {
        axiosClient.post("/lcdp-proxy/lowcode/platform/be/api/dict/getDictLabelValues", ['OBJECT_SOURCE_TYPE_DP','OBJECT_SOURCE_TYPE_FOUR','OBJECT_TYPE']).then((response) => {

<!-- JSON文件导入节点-节点配置信息-编辑页 -->

<template v-if="showNodeCfgEdit == 'JSONImportNode' && nodeCfgJson != null && nodeCfgJson.isListResult != null">
	<el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="文件来源">
                <el-select v-model="nodeCfgJson.jsonFileSource" clearable class="m-2" placeholder="Select" size="small">
                    <el-option v-for="item in jsonFileSourceOptions" :key="item.value" :label="item.label" :value="item.value" />
                </el-select>
            </el-form-item>
        </el-col>
	...
	<el-row :gutter="4">
        <el-col :span="16">
            <el-form-item label="文件名来源">
                <el-select v-model="nodeCfgJson.jsonFileNameSource" clearable class="m-2" placeholder="Select" size="small">
        ...
        <el-col :span="8">
            <el-form-item label="" label-width="10px">
                <el-link  type="primary" @click="showAvailableDataSelectPage(objectAttrSourceOptions, (contextType, contextKey)=>{this.nodeCfgJson.jsonFileNameSource=contextType;this.nodeCfgJson.jsonFileNameKey=contextKey;})" ><label>选择</label></el-link>&nbsp;
            </el-form-item>
        </el-col>
    </el-row>
    <el-row :gutter="4">
        <el-col :span="12">
            <el-form-item label="文件名Key">
                <el-input v-model="nodeCfgJson.jsonFileNameKey" size="small" />
            </el-form-item>
        </el-col>
        <el-col :span="12">
            <el-form-item label="文件名属性">
                <el-input v-model="nodeCfgJson.jsonFileNameAttr" size="small" />
            </el-form-item>
        </el-col>
    </el-row>
    <el-row :gutter="4">
...
export default {
    ...
    data() {            
    	const jsonFileSourceOptions = ref(null);
    ...
    mounted() {
        axiosClient.post("/lcdp-proxy/lowcode/platform/be/api/dict/getDictLabelValues", ['OBJECT_SOURCE_TYPE_WITH_PRE','FILE_SOURCE_TYPE','OBJECT_TYPE','FILE_PROCESS_MODE']).then((response) => {
            ...
            if(data != null && data.status == "200" && data.data != null) {
                ...
                this.jsonFileSourceOptions = data.data['FILE_SOURCE_TYPE'];

<!-- 编辑业务域 -->
<template>
<el-dialog v-model="showFlag" title="编辑业务域">
    <template #header>
        <span class="title">编辑业务域</span>
    </template>
        ...
        <el-row :gutter="4">
            <el-col :span="12">              
                <el-form-item label="标识" required prop="id">
                    <el-input v-model="businessDomain.id" readonly size="small"/>
                </el-form-item>
            </el-col>   
            <el-col :span="12">
    ...
    <template #footer>
        <span class="dialog-footer">
            <el-button @click="hideBusinessDomainEditPage()">取消</el-button>
            <el-button type="primary" @click="saveBusinessDomain()">确定</el-button>
        </span>
    </template>
</el-dialog>
...
export default {
    props: ['businessDomain', 'showBusinessDomainEdit'],
    
    emits: ['hideBusinessDomainEditPage', 'updateBusinessDomainToList'],
    
    setup(props, {attrs, emit, slots}) {
        const hideBusinessDomainEditPage = () => {
            emit('hideBusinessDomainEditPage');
        };
    ...
    computed: {
        showFlag: {
            get() {
                return this.showBusinessDomainEdit;
            },
            set(value) {
                this.hideBusinessDomainEditPage();
            }
        }
    },
    data() {
    ...
    methods: {
    	saveBusinessDomain() {
            var url = "/lcdp-proxy/lowcode/platform/be/api/businessDomain/save";

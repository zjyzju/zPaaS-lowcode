...
import cn.zpaas.lowcode.domain.mapper.DataTransferMethodMapper;
...
public class DataTransferMethod {
    ...
    @Autowired
    private DataTransferMethodMapper mapper;

    public List<DataTransferMethod> list() {
        DataTransferMethodExample criteria = new DataTransferMethodExample();

...
import cn.zpaas.lowcode.be.engine.ability.QuartzTaskAbility;
 ...
 */
@Component
public class QuartzCacheLoader implements AbilityCacheLoader {

    @Override
    public void loadCache(String systemId, String tenantId, EngineInitService initService) {
        QuartzTaskAbility.init(systemId, tenantId, initService);
		
    }

    @Override
    public void reloadCache(String systemId, String tenantId, EngineInitService initService) {
        QuartzTaskAbility.reloadCache(systemId, tenantId, initService);
    }

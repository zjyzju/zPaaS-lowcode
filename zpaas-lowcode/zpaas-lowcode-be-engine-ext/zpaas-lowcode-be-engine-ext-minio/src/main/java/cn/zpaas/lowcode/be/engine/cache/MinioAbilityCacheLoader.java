 ...
 */
@Component
public class MinioAbilityCacheLoader implements AbilityCacheLoader{

    @Override
    public void loadCache(String systemId, String tenantId, EngineInitService initService) {
        MinioRepositoryAbility.init(systemId, tenantId, initService);
    }

    @Override
    public void reloadCache(String systemId, String tenantId, EngineInitService initService) {
        MinioRepositoryAbility.reloadCache(systemId, tenantId, initService);
    }
